...
INSERT INTO `menuitem` VALUES (4001,'Pinot Noir 75cl','Drink',25.00),(4002,'Heineken 50cl','Drink',5.50),(4003,'Albariño 75cl','Drink',20.75),(4004,'Prawn Cocktail','Starter',17.50),(4005,'Escargot','Starter',14.99),(4006,'Carpaccio','Starter',15.50),(4007,'Steak and Kidney Pie','Main',25.00),(4008,'Coq au Vin','Main',28.00),(4009,'Boeuf Bourguignon','Main',27.00),(4010,'Sticky Toffee Pudding','Dessert',6.50),(4011,'Bread and Butter Pudding','Dessert',6.50),(4012,'Lemon-Ricotta Soufflé','Dessert',6.50);
...
CREATE TABLE `order` (
  ...
  CONSTRAINT `BookingID_fk` FOREIGN KEY (`BookingID`) REFERENCES `booking` (`BookingID`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `StaffID_fk` FOREIGN KEY (`StaffID`) REFERENCES `staff` (`StaffID`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `StatusID_fk` FOREIGN KEY (`StatusID`) REFERENCES `status` (`StatusID`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `orderline` (
  ...
  CONSTRAINT `ItemID_fk` FOREIGN KEY (`ItemID`) REFERENCES `menuitem` (`ItemID`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `OrderID_fk` FOREIGN KEY (`OrderID`) REFERENCES `order` (`OrderID`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `staff` VALUES (3001,'John Beckham','Waiter',65000),(3002,'Lucas Colson','Junior Waiter',55000),(3003,'Liam Taylor','Head Waiter',70000),(3004,'Abbott','Waiter',60000),(3005,'Henry Miller','Junior Waiter',50000),(3006,'Oliver Banks','Waiter',60000);
...
INSERT INTO `status` VALUES (5001,'Drinks Served'),(5002,'Starters Served'),(5003,'Mains Served'),(5004,'Desserts Served'),(5005,'Customer Paid');
...
-- Dump completed on 2023-12-21 11:47:57
